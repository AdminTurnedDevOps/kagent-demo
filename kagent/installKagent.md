...
export BACKEND_ISSUER=http://YOUR_LB_IP:8080/realms/master
export FRONTEND_CLIENT_ID=
export FRONTEND_AUTH_ENDPOINT=http://YOUR_LB_IP:8080/realms/master/protocol/openid-connect/auth
export FRONTEND_LOGOUT_ENDPOINT=http://YOUR_LB_IP:8080/realms/master/protocol/openid-connect/logout
export FRONTEND_TOKEN_ENDPOINT=http://YOUR_LB_IP:8080/realms/master/protocol/openid-connect/token
export CLUSTER1=
```
